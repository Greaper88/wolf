...
|WOLF_WAYLAND_SOCKET_WAIT_TIMEOUT_MS
|5000
...
|1000
|The default UID that apps run as, applied to newly paired clients; existing clients keep their saved values

|WOLF_DEFAULT_RUN_GID
|1000
|The default GID that apps run as, applied to newly paired clients; existing clients keep their saved values
|===
...
id = 'moonlight-profile-id'
    ...
    icon_png_path = "https://raw.githubusercontent.com/games-on-whales/wolf-ui/refs/heads/main/src/Icons/wolf_ui_icon.png"
        ...
        type = 'docker'
        name = 'Wolf-UI'
        image = 'ghcr.io/greaper88/wolf-ui:gpu-selection-dev'
        devices = []
        env = [
